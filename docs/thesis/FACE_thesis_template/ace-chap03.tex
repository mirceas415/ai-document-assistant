...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.95\textwidth]{img/diagrams/DIA-01-high-level-architecture.pdf}
	\caption{High-level architecture of the AI Document Assistant.}
...
need database-specific operators. These framework roles describe the
checked-in application structure rather than a general comparison of backend
frameworks.
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.95\textwidth]{img/diagrams/DIA-02-domain-workspace-model.pdf}
	\caption{Conceptual workspace and document-reuse domain model.}
...
document and chunk identifiers \cite{PostgreSQLFTS,PgvectorDocs}.
...
hybrid order remains the fallback. These stages apply established RAG, rank
fusion, and passage-reranking ideas \cite{Lewis2020RAG,Cormack2009RRF,Nogueira2019BERT}.
...
document content as safe \cite{Abdelnabi2023IndirectPromptInjection,OWASPPromptInjection}.
...
scope. The engineering contribution lies in enforcing these rules
